...
# Varianzhomogenität
# für die Funktion leveneTest() darf die unabhänigige Variable nicht numerisch sein, 
# daher verwenden wir as.factor()
...
**Hinweis:** Dies funktioniert nicht, wenn der *fixed effect* (wie "Days" aus den "sleepstudy"-Daten) numerisch ist. 
...
```{r glm linearity, echo=T, fig.align = "left"}
